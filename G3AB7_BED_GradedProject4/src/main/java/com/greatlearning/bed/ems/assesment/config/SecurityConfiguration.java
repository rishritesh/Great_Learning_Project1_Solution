...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		antMatchers("/","/addemp","/saveEmp","/viewEmployee","/searchByorder","/searchEmployeeorder","/searchEmp/**").hasAnyAuthority("USER","ADMIN")
		.antMatchers("/**").hasAnyAuthority("ADMIN").anyRequest()
